...
namespace Backlog.Filters
{
    public class RateLimitAttribute : ActionFilterAttribute
    {
        ...
        [Dependency]
        public IIpRepository _ipRepository { get; set; }
