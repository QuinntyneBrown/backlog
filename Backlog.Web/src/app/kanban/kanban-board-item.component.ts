...
export class KanbanBoardItemComponent extends HTMLElement {
    ...
    private _onDeleteClick(e:Event) {
        this._kanbanBoardService.remove({ id: this.entity.id }).then(() => {
            this.parentNode.removeChild(this);
        });
    }

    private _onEditClick() {
        this._router.navigate(["kanbanboard", "edit", this.entity.id]);
    }

    private _onViewClick() {
        this._router.navigate(["kanbanboard","view",this.entity.id]);
    }
